...
public class AdapterCarItem extends RecyclerView.Adapter<AdapterCarItem.HolderCartItem> {

    private Context context;
    private ArrayList<ModelCartItem> cartItems;

    public AdapterCarItem(Context context, ArrayList<ModelCartItem> cartItems) {
    ...
    public void onBindViewHolder(@NonNull HolderCartItem holder, final int position) {
        ...
        final String cost = modelCartItem.getCast();
        ...
        // handle remove click listener, delete item form cart
